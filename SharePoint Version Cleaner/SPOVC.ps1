...
function Show-CleanupOptions {
    ...
    $cleanupForm.Size = New-Object System.Drawing.Size(500, 400)
    ...
    $dryRunFolderButton.Location = New-Object System.Drawing.Point(50, 170)
    $dryRunFolderButton.Size = New-Object System.Drawing.Size(400, 40)
    $dryRunFolderButton.Text = "Dry Run - Single Folder"
    $dryRunFolderButton.BackColor = [System.Drawing.Color]::LightYellow
    $dryRunFolderButton.Add_Click({
        $cleanupForm.Hide()
        Show-FolderDialog -Mode "dry"
        $cleanupForm.Close()
    })
    $cleanupForm.Controls.Add($dryRunFolderButton)
    ...
    $cleanupFolderButton.Location = New-Object System.Drawing.Point(50, 270)
    $cleanupFolderButton.Size = New-Object System.Drawing.Size(400, 40)
    $cleanupFolderButton.Text = "CLEANUP - Single Folder (DELETE VERSIONS)"
    ...
    $cleanupFolderButton.Add_Click({
        ...
        if ($result -eq [System.Windows.Forms.DialogResult]::Yes) {
            $cleanupForm.Hide()
            Show-FolderDialog -Mode "run"
            $cleanupForm.Close()
        }
    })
    $cleanupForm.Controls.Add($cleanupFolderButton)

    $backButton = New-Object System.Windows.Forms.Button
    $backButton.Location = New-Object System.Drawing.Point(200, 330)
    $backButton.Size = New-Object System.Drawing.Size(100, 30)
    $backButton.Text = "Back"
    $backButton.Add_Click({
        $cleanupForm.Close()
